...
<div class="grid gap-12">
    ...
    <div class="md:flex gap-12 p-8" id="about">
        ...
        <div id="community" class="text-center md:w-1/3 text-green-400 md:mt-0 mt-6">
            ...
            <p class="text-slate-300 mb-8">The Dronies community is incredibly active and fun. Whether you're an NFT noob or a seasoned crypto veteran from the foothills of Mt. Gox, there's a place for you here.</p>
            <div class="border-4 border-green-400 flex px-8 py-4 items-center gap-3 justify-center w-1/2 mx-auto">
                ...
                <a href="https://discord.com/invite/8naUgEcYEx" class="font-bold uppercase text-3xl font-serif discord-link">Discord</a>
            </div>
        </div>
    </div>
</div>
